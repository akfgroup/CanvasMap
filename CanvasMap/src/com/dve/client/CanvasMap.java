...
public class CanvasMap implements EntryPoint {
	...
	Button bigBtn = new Button("Big");
	Button smBtn = new Button("Small");
...
//		RootPanel.get().add(new Label("Hello World!"));
	...
	private void startUp() {
		...
		linkShapeDialog = new LinkShapeDialog(canvasMap);
		...
		addBtn.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				LinkShape linkShape = new LinkShape(canvasMap, scrollPanel.getHorizontalScrollPosition()+(scrollPanel.getOffsetWidth()/2), scrollPanel.getVerticalScrollPosition()+(scrollPanel.getOffsetHeight()/2));
		...
		smBtn.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				zoom = zoom - .1;
				clear();
				draw();
		...
		bigBtn.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				zoom = zoom + .1;
				clear();
				draw();
